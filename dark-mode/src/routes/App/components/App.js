    ...
    <div className="app">
      <div className="level">
        ...
        <button className="app__dark-mode-btn icon level-right" onClick={() => { setDarkMode({ darkMode: !darkMode }); }}>
          {
            darkMode ? ( <FontAwesomeIcon className="animated bounceIn fast" icon={faSun} color="#FFA500"/>
            ): null
          }
          {
            !darkMode ? <FontAwesomeIcon className="animated bounceIn fast" icon={faMoon} />
              : null
          }
        </button>
